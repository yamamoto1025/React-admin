...
import { selectBoards, getBoards, resetBoards, newBoard } from '../store/boardsSlice';
        ...
        >
          ...
          <motion.div variants={item} className="w-224 h-224 p-16">
            <Paper
              ...
              onClick={() => {
                dispatch(newBoard()).then((payload) => {
                  // history.push({
                  //   pathname: `/apps/scrumboard/boards/${payload.id}/${payload.uri}`,
                  // });
                });
              }}
