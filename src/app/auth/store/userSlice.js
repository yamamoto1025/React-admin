...
export const setUserDataFoxConnect = (foxUser, authUser, role) => async (dispatch, getState) => {
...
export const createUserSettingsFoxConnect = (authUser) => async (dispatch, getState) => {
  const fuseDefaultSettings = getState().fuse.settings.defaults;
...
export const updateUserRoleFoxConnect = (organization) => async (dispatch, getState) => {
...
export const setUserData = (user) => async (dispatch, getState) => {
  ...
  history.location.state = {
    redirectUrl: '/organization', // for example 'apps/academy'
  };
